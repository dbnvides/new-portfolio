...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    name: "Portfólio",
    descricao:
      "Este portfólio, mostrando alguns projetos que ja realizei de forma organizada!",
    repositorio: "https://github.com/dbnvides/new-portfolio",
    deploy: "https://portfolio-dionisio-santos.vercel.app/",
    tecnologias: [
      "TypeScript",
      "Reactjs",
      "TailwindCSS",
